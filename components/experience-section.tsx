                ...
                <div className="relative bg-slate-800/40 backdrop-blur-xl border border-slate-700/50 rounded-2xl p-8 hover:border-emerald-400/50 transition-all duration-500">
                  ...
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-emerald-400 font-medium">{exp.company_name}</p>
                    </div>
                  </div>
                  ...
                  <div className="space-y-2">
                    {exp.points.map((point, pointIndex) => (
                      <div key={pointIndex} className="flex items-start gap-3 text-slate-300">
                        <div className="w-1.5 h-1.5 bg-emerald-400 rounded-full mt-2 flex-shrink-0" />
                        <p className="leading-relaxed text-sm">{point}</p>
                      </div>
                    ))}
                  </div>
